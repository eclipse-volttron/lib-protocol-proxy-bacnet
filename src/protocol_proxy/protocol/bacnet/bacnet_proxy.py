...
class BACnetProxy(AsyncioProtocolProxy):
    ...
    async def confirmed_private_transfer_endpoint(self, _, raw_message: bytes):
        ...
        # TODO: Implement proper TagList parsing from JSON
        service_parameters = message.get('service_parameters', None)
        if service_parameters:
            # Convert to TagList if needed - for now pass as None
